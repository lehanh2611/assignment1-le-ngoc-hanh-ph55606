...
struct ProgramProviderStruct* initializationPrograms() {
    ...
    programs->programProvider[1] = &CommonNumbers;
...
int main() {
    ...
    programProvider->programProvider[0]->program(); // Run OK

    if (true) {
        programProvider->programProvider[0]->program(); // Error: EXC_BAD_ACCESS
    }

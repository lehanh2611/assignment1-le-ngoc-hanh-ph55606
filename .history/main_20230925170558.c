...
// #1
void checkIntegerProgram() { printf("Chương trình Kiểm Tra Số Nguyên\n"); }

// #2
void commonNumbersProgram() {
    printf("Chương trình Tìm Ước Số Chung Và Bội Số Chung Của 2 Số\n");
}

// #3
void billingKaraokeProgram() {
    printf("Chương trình Tính Tiền Cho Quán Karaoke\n");
}

// #4
void calculateElectricityProgram() { printf("Chương trình Tính Tiền Điện\n"); }

// #5
void moneyExchangeProgram() { printf("Chương trình Đổi Tiền\n"); }

// #6
void calculateLoanInterestProgram() {
    printf("Chương trình Tính Lãi Suất Vay Ngân Hàng Vay Trả Góp\n");
}

// #7
void borrowMoneyBuyCarProgram() { printf("Chương trình Vay Tiền Mua Xe\n"); }

// #8
void studentPlacementProgram() {
    printf("Chương trình Sắp Xếp Thông Tin Sinh Viên\n");
}

// # 9
void gameFpolyLottProgram() { printf("Chương trình Game FPOLY-LOTT\n"); }

// # 10
void fractionCalculationProgram() {
    printf("Chương trình Tính Toán Phân Số\n");
}
// END
...
void backMenu() {
    printf("\*********************************\n");
    printf("[home] Quay lại Menu chính\n");
    printf("[reset] Làm mới chương trình\n");
}
void mainMenu() {
    int input;

...
struct ProgramProviderStruct initializationPrograms() {
    ...
    struct ProgramProviderStruct* programProvider =
        (struct ProgramProviderStruct)malloc(quantityProgram *
                                             (struct ProgramProviderStruct));
...
int main() {
    struct ProgramStruct* programStruct =
        (struct ProgramStruct*)malloc(sizeof(struct ProgramStruct));
    struct ProgramProviderStruct* programProvider =
        (struct ProgramProviderStruct*)calloc(initializationPrograms(),
                                              sizeof(2));
    ;

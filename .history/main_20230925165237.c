...
// #1
void checkIntegerProgram() { printf("Kiểm Tra Số Nguyên"); }
...
// #3
void billingKaraokeProgram() { printf("Tính Tiền Cho Quán Karaoke"); }

// #4
void calculateElectricityProgram() { printf("Tính Tiền Điện"); }

// #5
void moneyExchangeProgram() { printf("Đổi Tiền"); }

// #6
void calculateLoanInterestProgram() {
    printf("Tính Lãi Suất Vay Ngân Hàng Vay Trả Góp");
}

// #7
void borrowMoneyBuyCarProgram() { printf("Vay Tiền Mua Xe"); }

// #8
void studentPlacementProgram() { printf("Sắp Xếp Thông Tin Sinh Viên"); }

// # 9
void gameFpolyLottProgram() { printf("Game FPOLY-LOTT"); }

// # 10
void fractionCalculationProgram() { printf("Tính Toán Phân Số"); }
// END

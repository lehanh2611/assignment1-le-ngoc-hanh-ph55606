...
struct ProgramProviderStruct {
    int quantityProgram;
    struct ProgramStruct* programProvider[]
};
...
struct ProgramProviderStruct initializationPrograms() {
    ...
    printf("%d", sizeof(programProvider));

    programProvider.programProvider[0] = &checkInteger;
    programProvider.programProvider[10] = &checkInteger;
    programProvider.programProvider[10]->program();

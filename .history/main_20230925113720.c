...
struct ProgramProviderStruct* initializationPrograms() {
    ...
    programProvider->programs[0]->name = "CheckInteger";
    programProvider->programs[1]->name = "CommonNumbers";
...
int main() {
    ...
    if (true) {
        printf("%d", programProvider->quantityProgram);
        printf("%s", programProvider->programs[0]->name);
        programProvider->programs[0]->nameProgram; // Error: EXC_BAD_ACCESS
    }
